 ...
 * generated by Xtext
 */
package br.ufpe.cin.ui.contentassist.antlr;
...
public class TupiParser extends AbstractContentAssistParser {
	...
	@Override
	protected br.ufpe.cin.ui.contentassist.antlr.internal.InternalTupiParser createParser() {
		br.ufpe.cin.ui.contentassist.antlr.internal.InternalTupiParser result = new br.ufpe.cin.ui.contentassist.antlr.internal.InternalTupiParser(null);
	...
	protected String getRuleName(AbstractElement element) {
		if (nameMappings == null) {
			nameMappings = new HashMap<AbstractElement, String>() {
				...
				{
					put(grammarAccess.getSTATEPATTERNDECLAccess().getAlternatives(), "rule__STATEPATTERNDECL__Alternatives");
					...
					put(grammarAccess.getMachineDeclAccess().getGroup(), "rule__MachineDecl__Group__0");
					put(grammarAccess.getMachineDeclAccess().getGroup_2(), "rule__MachineDecl__Group_2__0");
					put(grammarAccess.getMachineBodyAccess().getGroup(), "rule__MachineBody__Group__0");
					put(grammarAccess.getEventsDeclAccess().getGroup(), "rule__EventsDecl__Group__0");
					...
					put(grammarAccess.getTransitionAccess().getGroup_12_2(), "rule__Transition__Group_12_2__0");
					put(grammarAccess.getTransitionAccess().getGroup_13(), "rule__Transition__Group_13__0");
					put(grammarAccess.getActionsDeclAccess().getGroup(), "rule__ActionsDecl__Group__0");
					put(grammarAccess.getActionAccess().getGroup(), "rule__Action__Group__0");
					put(grammarAccess.getTriggerEventAccess().getGroup(), "rule__TriggerEvent__Group__0");
					put(grammarAccess.getTriggerEventAccess().getGroup_2(), "rule__TriggerEvent__Group_2__0");
					put(grammarAccess.getTriggerEventAccess().getGroup_2_1(), "rule__TriggerEvent__Group_2_1__0");
					put(grammarAccess.getTriggerEventAccess().getGroup_3(), "rule__TriggerEvent__Group_3__0");
					put(grammarAccess.getGuardsDeclAccess().getGroup(), "rule__GuardsDecl__Group__0");
					put(grammarAccess.getGuardsDeclAccess().getGroup_3(), "rule__GuardsDecl__Group_3__0");
					put(grammarAccess.getGuardAccess().getGroup(), "rule__Guard__Group__0");
					put(grammarAccess.getMemoryDeclAccess().getGroup(), "rule__MemoryDecl__Group__0");
					put(grammarAccess.getMemoryDeclAccess().getGroup_2(), "rule__MemoryDecl__Group_2__0");
					put(grammarAccess.getMemoryDeclAccess().getGroup_2_1(), "rule__MemoryDecl__Group_2_1__0");
					...
					put(grammarAccess.getStateDeclAccess().getGroup_3(), "rule__StateDecl__Group_3__0");
					put(grammarAccess.getSTATEPATTERNDECLAccess().getGroup_0(), "rule__STATEPATTERNDECL__Group_0__0");
					put(grammarAccess.getVariableListDeclAccess().getGroup(), "rule__VariableListDecl__Group__0");
					put(grammarAccess.getVariableListDeclAccess().getGroup_2(), "rule__VariableListDecl__Group_2__0");
					...
					put(grammarAccess.getModelAccess().getNamespaceAssignment_0(), "rule__Model__NamespaceAssignment_0");
					put(grammarAccess.getModelAccess().getUseAssignment_1(), "rule__Model__UseAssignment_1");
					...
					put(grammarAccess.getUseDeclAccess().getImportedNamespaceAssignment_1(), "rule__UseDecl__ImportedNamespaceAssignment_1");
					put(grammarAccess.getMachineDeclAccess().getNameAssignment_1(), "rule__MachineDecl__NameAssignment_1");
					put(grammarAccess.getMachineDeclAccess().getSuperTypeAssignment_2_1(), "rule__MachineDecl__SuperTypeAssignment_2_1");
					put(grammarAccess.getMachineDeclAccess().getBodyAssignment_3(), "rule__MachineDecl__BodyAssignment_3");
					put(grammarAccess.getMachineBodyAccess().getMemoriesDeclAssignment_1(), "rule__MachineBody__MemoriesDeclAssignment_1");
					put(grammarAccess.getMachineBodyAccess().getStatesDeclAssignment_2(), "rule__MachineBody__StatesDeclAssignment_2");
					put(grammarAccess.getMachineBodyAccess().getGuardsDeclAssignment_3(), "rule__MachineBody__GuardsDeclAssignment_3");
					put(grammarAccess.getMachineBodyAccess().getActionsDeclAssignment_4(), "rule__MachineBody__ActionsDeclAssignment_4");
					put(grammarAccess.getMachineBodyAccess().getEventsDeclAssignment_5(), "rule__MachineBody__EventsDeclAssignment_5");
					put(grammarAccess.getEventsDeclAccess().getEventsAssignment_2(), "rule__EventsDecl__EventsAssignment_2");
					put(grammarAccess.getEventAccess().getNameAssignment_1(), "rule__Event__NameAssignment_1");
					put(grammarAccess.getEventAccess().getParametersAssignment_3(), "rule__Event__ParametersAssignment_3");
					put(grammarAccess.getEventAccess().getTransitionsAssignment_4(), "rule__Event__TransitionsAssignment_4");
					put(grammarAccess.getTransitionAccess().getOriginStatesAssignment_3(), "rule__Transition__OriginStatesAssignment_3");
					put(grammarAccess.getTransitionAccess().getOriginStatesAssignment_4_1(), "rule__Transition__OriginStatesAssignment_4_1");
					put(grammarAccess.getTransitionAccess().getDestStateAssignment_7(), "rule__Transition__DestStateAssignment_7");
					put(grammarAccess.getTransitionAccess().getGuardAssignment_9(), "rule__Transition__GuardAssignment_9");
					put(grammarAccess.getTransitionAccess().getActionAssignment_11(), "rule__Transition__ActionAssignment_11");
					put(grammarAccess.getTransitionAccess().getParametersAssignment_12_1(), "rule__Transition__ParametersAssignment_12_1");
					put(grammarAccess.getTransitionAccess().getParametersAssignment_12_2_1(), "rule__Transition__ParametersAssignment_12_2_1");
					put(grammarAccess.getTransitionAccess().getTriggersAssignment_13_1(), "rule__Transition__TriggersAssignment_13_1");
					put(grammarAccess.getActionsDeclAccess().getActionsAssignment_2(), "rule__ActionsDecl__ActionsAssignment_2");
					put(grammarAccess.getActionAccess().getNameAssignment_0(), "rule__Action__NameAssignment_0");
					put(grammarAccess.getActionAccess().getVariableListDeclAssignment_1(), "rule__Action__VariableListDeclAssignment_1");
					put(grammarAccess.getActionAccess().getBlockAssignment_2(), "rule__Action__BlockAssignment_2");
					put(grammarAccess.getTriggerEventAccess().getEventAssignment_1(), "rule__TriggerEvent__EventAssignment_1");
					put(grammarAccess.getTriggerEventAccess().getParametersAssignment_2_0(), "rule__TriggerEvent__ParametersAssignment_2_0");
					put(grammarAccess.getTriggerEventAccess().getParametersAssignment_2_1_1(), "rule__TriggerEvent__ParametersAssignment_2_1_1");
					put(grammarAccess.getTriggerEventAccess().getMachineAssignment_3_1(), "rule__TriggerEvent__MachineAssignment_3_1");
					put(grammarAccess.getGuardsDeclAccess().getGuardsAssignment_2(), "rule__GuardsDecl__GuardsAssignment_2");
					put(grammarAccess.getGuardsDeclAccess().getGuardsAssignment_3_1(), "rule__GuardsDecl__GuardsAssignment_3_1");
					put(grammarAccess.getGuardAccess().getNameAssignment_0(), "rule__Guard__NameAssignment_0");
					put(grammarAccess.getGuardAccess().getExprAssignment_2(), "rule__Guard__ExprAssignment_2");
					put(grammarAccess.getMemoryDeclAccess().getMemoriesAssignment_2_0(), "rule__MemoryDecl__MemoriesAssignment_2_0");
					put(grammarAccess.getMemoryDeclAccess().getMemoriesAssignment_2_1_1(), "rule__MemoryDecl__MemoriesAssignment_2_1_1");
					put(grammarAccess.getMemoryAccess().getTypeAssignment_0(), "rule__Memory__TypeAssignment_0");
					put(grammarAccess.getMemoryAccess().getNameAssignment_1(), "rule__Memory__NameAssignment_1");
					put(grammarAccess.getTypeAccess().getTypeRefAssignment(), "rule__Type__TypeRefAssignment");
					put(grammarAccess.getStateDeclAccess().getStatesAssignment_2(), "rule__StateDecl__StatesAssignment_2");
					put(grammarAccess.getStateDeclAccess().getStatesAssignment_3_1(), "rule__StateDecl__StatesAssignment_3_1");
					put(grammarAccess.getStateAccess().getNameAssignment(), "rule__State__NameAssignment");
					put(grammarAccess.getVariableListDeclAccess().getVariablesDeclAssignment_1(), "rule__VariableListDecl__VariablesDeclAssignment_1");
					put(grammarAccess.getVariableListDeclAccess().getVariablesDeclAssignment_2_1(), "rule__VariableListDecl__VariablesDeclAssignment_2_1");
