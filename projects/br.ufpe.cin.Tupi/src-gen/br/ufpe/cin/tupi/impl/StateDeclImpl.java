 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufpe.cin.tupi.impl.StateDeclImpl#getStates <em>States</em>}</li>
 * </ul>
 *
 * @generated
 */
public class StateDeclImpl extends MinimalEObjectImpl.Container implements StateDecl
{
  ...
  {
    return TupiPackage.Literals.STATE_DECL;
  }
  ...
  public EList<State> getStates()
  {
    if (states == null)
    {
      states = new EObjectContainmentEList<State>(State.class, this, TupiPackage.STATE_DECL__STATES);
    }
    return states;
  }
  ...
  public NotificationChain eInverseRemove(InternalEObject otherEnd, int featureID, NotificationChain msgs)
  {
    switch (featureID)
    {
      case TupiPackage.STATE_DECL__STATES:
