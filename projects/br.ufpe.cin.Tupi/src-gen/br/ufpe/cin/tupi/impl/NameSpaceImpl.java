 ...
 * </p>
 * <ul>
 *   <li>{@link br.ufpe.cin.tupi.impl.NameSpaceImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class NameSpaceImpl extends MinimalEObjectImpl.Container implements NameSpace
{
  ...
  {
    return TupiPackage.Literals.NAME_SPACE;
  }
  ...
  public void setName(String newName)
  {
    ...
    if (eNotificationRequired())
      eNotify(new ENotificationImpl(this, Notification.SET, TupiPackage.NAME_SPACE__NAME, oldName, name));
  }
  ...
  public Object eGet(int featureID, boolean resolve, boolean coreType)
  {
    switch (featureID)
    {
      case TupiPackage.NAME_SPACE__NAME:
        return getName();
    }
