...
*/
    ...
    public InternalTupiParser(TokenStream input, TupiGrammarAccess grammarAccess) {
        this(input);
    ...
    protected String getFirstRuleName() {
   	...
   	@Override
   	protected TupiGrammarAccess getGrammarAccess() {
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getUseUseDeclParserRuleCall_1_0()); 
	    }
		lv_use_1_0=ruleUseDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModelRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getModelAccess().getMachinesMachineDeclParserRuleCall_2_0()); 
	    }
		lv_machines_2_0=ruleMachineDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getModelRule());
	        }
       		add(
...
(	otherlv_0='use' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getUseDeclAccess().getUseKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getUseDeclAccess().getImportedNamespaceQualifiedNameParserRuleCall_1_0()); 
	    }
...
entryRuleMachineDecl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMachineDeclRule()); }
	 iv_ruleMachineDecl=ruleMachineDecl 
	 { $current=$iv_ruleMachineDecl.current; } 
	 EOF 
;

// Rule MachineDecl
ruleMachineDecl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='machine' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getMachineDeclAccess().getMachineKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
		{
			newLeafNode(lv_name_1_0, grammarAccess.getMachineDeclAccess().getNameIDTerminalRuleCall_1_0()); 
		}
		{
	        if ($current==null) {
	            $current = createModelElement(grammarAccess.getMachineDeclRule());
	        }
       		setWithLastConsumed(
       			$current, 
       			"name",
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getMachineDeclAccess().getExtendsKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMachineDeclAccess().getSuperTypeTypeParserRuleCall_2_1_0()); 
	    }
		lv_superType_3_0=ruleType		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMachineDeclRule());
	        }
       		set(
       			$current, 
       			"superType",
...
(
		{ 
	        newCompositeNode(grammarAccess.getMachineDeclAccess().getBodyMachineBodyParserRuleCall_3_0()); 
	    }
		lv_body_4_0=ruleMachineBody		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMachineDeclRule());
	        }
       		set(
...
entryRuleMachineBody returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMachineBodyRule()); }
...
((
	...
	}
    {
        $current = forceCreateModelElement(
            grammarAccess.getMachineBodyAccess().getMachineBodyAction_0(),
            $current);
    }
)(
(
		{ 
	        newCompositeNode(grammarAccess.getMachineBodyAccess().getMemoriesDeclMemoryDeclParserRuleCall_1_0()); 
	    }
		lv_memoriesDecl_1_0=ruleMemoryDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMachineBodyRule());
	        }
       		set(
       			$current, 
       			"memoriesDecl",
...
(
		{ 
	        newCompositeNode(grammarAccess.getMachineBodyAccess().getStatesDeclStateDeclParserRuleCall_2_0()); 
	    }
		lv_statesDecl_2_0=ruleStateDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMachineBodyRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getMachineBodyAccess().getGuardsDeclGuardsDeclParserRuleCall_3_0()); 
	    }
		lv_guardsDecl_3_0=ruleGuardsDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMachineBodyRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getMachineBodyAccess().getActionsDeclActionsDeclParserRuleCall_4_0()); 
	    }
		lv_actionsDecl_4_0=ruleActionsDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMachineBodyRule());
	        }
       		set(
...
(
		{ 
	        newCompositeNode(grammarAccess.getMachineBodyAccess().getEventsDeclEventsDeclParserRuleCall_5_0()); 
	    }
		lv_eventsDecl_5_0=ruleEventsDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMachineBodyRule());
	        }
       		set(
...
entryRuleEventsDecl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getEventsDeclRule()); }
	 iv_ruleEventsDecl=ruleEventsDecl 
	 { $current=$iv_ruleEventsDecl.current; } 
	 EOF 
;

// Rule EventsDecl
ruleEventsDecl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getEventsDeclAccess().getEventsDeclAction_0(),
            $current);
    }
)	otherlv_1='events' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getEventsDeclAccess().getEventsKeyword_1());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getEventsDeclAccess().getEventsEventParserRuleCall_2_0()); 
	    }
		lv_events_2_0=ruleEvent		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getEventsDeclRule());
	        }
       		add(
       			$current, 
       			"events",
...
(	otherlv_0='{' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getEventAccess().getLeftCurlyBracketKeyword_0());
    }
(
(
		lv_name_1_0=RULE_ID
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getEventAccess().getRightCurlyBracketKeyword_2());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getEventAccess().getParametersVariableListDeclParserRuleCall_3_0()); 
	    }
		lv_parameters_3_0=ruleVariableListDecl		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getEventAccess().getTransitionsTransitionParserRuleCall_4_0()); 
	    }
...
((
    ...
    {
    	newLeafNode(otherlv_1, grammarAccess.getTransitionAccess().getWhenKeyword_1());
    }
	otherlv_2='[' 
    {
...
(
		{ 
	        newCompositeNode(grammarAccess.getTransitionAccess().getOriginStatesSTATEPATTERNDECLParserRuleCall_3_0()); 
	    }
		lv_originStates_3_0=ruleSTATEPATTERNDECL		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getTransitionAccess().getOriginStatesSTATEPATTERNDECLParserRuleCall_4_1_0()); 
	    }
		lv_originStates_5_0=ruleSTATEPATTERNDECL		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTransitionRule());
	        }
       		add(
	...
	otherlv_7='->' 
    {
    	newLeafNode(otherlv_7, grammarAccess.getTransitionAccess().getHyphenMinusGreaterThanSignKeyword_6());
    }
(
(
		{ 
	...
	otherlv_8=RULE_ID
	{
		newLeafNode(otherlv_8, grammarAccess.getTransitionAccess().getDestStateStateCrossReference_7_0()); 
	}

)
)	otherlv_9='if' 
    {
    	newLeafNode(otherlv_9, grammarAccess.getTransitionAccess().getIfKeyword_8());
    }
(
(
		{ 
	...
	otherlv_10=RULE_ID
	{
		newLeafNode(otherlv_10, grammarAccess.getTransitionAccess().getGuardGuardCrossReference_9_0()); 
	}

)
)	otherlv_11='do' 
    {
    	newLeafNode(otherlv_11, grammarAccess.getTransitionAccess().getDoKeyword_10());
    }
(
(
		{ 
	...
	otherlv_12=RULE_ID
	{
		newLeafNode(otherlv_12, grammarAccess.getTransitionAccess().getActionActionCrossReference_11_0()); 
	}

)
)(	otherlv_13='(' 
    {
    	newLeafNode(otherlv_13, grammarAccess.getTransitionAccess().getLeftParenthesisKeyword_12_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTransitionAccess().getParametersXExpressionParserRuleCall_12_1_0()); 
	    }
		lv_parameters_14_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTransitionRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_15, grammarAccess.getTransitionAccess().getCommaKeyword_12_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTransitionAccess().getParametersXExpressionParserRuleCall_12_2_1_0()); 
	    }
		lv_parameters_16_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTransitionRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_17, grammarAccess.getTransitionAccess().getRightParenthesisKeyword_12_3());
    }
)?(	otherlv_18='=>' 
    {
    	newLeafNode(otherlv_18, grammarAccess.getTransitionAccess().getEqualsSignGreaterThanSignKeyword_13_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTransitionAccess().getTriggersTriggerEventParserRuleCall_13_1_0()); 
	    }
		lv_triggers_19_0=ruleTriggerEvent		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTransitionRule());
	        }
       		add(
...
entryRuleActionsDecl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getActionsDeclRule()); }
	 iv_ruleActionsDecl=ruleActionsDecl 
	 { $current=$iv_ruleActionsDecl.current; } 
	 EOF 
;

// Rule ActionsDecl
ruleActionsDecl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
...
(
		{ 
	        newCompositeNode(grammarAccess.getActionAccess().getVariableListDeclVariableListDeclParserRuleCall_1_0()); 
	    }
		lv_variableListDecl_1_0=ruleVariableListDecl		{
	        if ($current==null) {
...
(
		{ 
	        newCompositeNode(grammarAccess.getActionAccess().getBlockXBlockExpressionParserRuleCall_2_0()); 
	    }
		lv_block_2_0=ruleXBlockExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getActionRule());
	        }
       		set(
...
(	otherlv_0='trigger' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getTriggerEventAccess().getTriggerKeyword_0());
    }
(
(
		{ 
		...
		{
			if ($current==null) {
	            $current = createModelElement(grammarAccess.getTriggerEventRule());
	        }
        }
	otherlv_1=RULE_ID
	{
		newLeafNode(otherlv_1, grammarAccess.getTriggerEventAccess().getEventEventCrossReference_1_0()); 
	}
...
(
		{ 
	        newCompositeNode(grammarAccess.getTriggerEventAccess().getParametersXExpressionParserRuleCall_2_0_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getTriggerEventAccess().getCommaKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getTriggerEventAccess().getParametersXExpressionParserRuleCall_2_1_1_0()); 
	    }
		lv_parameters_4_0=ruleXExpression		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getTriggerEventRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_5, grammarAccess.getTriggerEventAccess().getOnKeyword_3_0());
    }
(
(
		{ 
	...
	otherlv_6=RULE_ID
	{
		newLeafNode(otherlv_6, grammarAccess.getTriggerEventAccess().getMachineMemoryCrossReference_3_1_0()); 
	}
...
entryRuleGuardsDecl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getGuardsDeclRule()); }
	 iv_ruleGuardsDecl=ruleGuardsDecl 
	 { $current=$iv_ruleGuardsDecl.current; } 
	 EOF 
;

// Rule GuardsDecl
ruleGuardsDecl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getGuardsDeclAccess().getGuardsDeclAction_0(),
            $current);
    }
)	otherlv_1='guards' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getGuardsDeclAccess().getGuardsKeyword_1());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getGuardsDeclAccess().getGuardsGuardParserRuleCall_2_0()); 
	    }
		lv_guards_2_0=ruleGuard		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getGuardsDeclRule());
	        }
       		add(
       			$current, 
       			"guards",
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getGuardsDeclAccess().getCommaKeyword_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getGuardsDeclAccess().getGuardsGuardParserRuleCall_3_1_0()); 
	    }
		lv_guards_4_0=ruleGuard		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getGuardsDeclRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getGuardAccess().getExprXExpressionParserRuleCall_2_0()); 
	    }
...
entryRuleMemoryDecl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getMemoryDeclRule()); }
	 iv_ruleMemoryDecl=ruleMemoryDecl 
	 { $current=$iv_ruleMemoryDecl.current; } 
	 EOF 
;

// Rule MemoryDecl
ruleMemoryDecl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getMemoryDeclAccess().getMemoryDeclAction_0(),
            $current);
    }
)	otherlv_1='memory' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getMemoryDeclAccess().getMemoryKeyword_1());
    }
((
(
		{ 
	        newCompositeNode(grammarAccess.getMemoryDeclAccess().getMemoriesMemoryParserRuleCall_2_0_0()); 
	    }
		lv_memories_2_0=ruleMemory		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMemoryDeclRule());
	        }
       		add(
       			$current, 
       			"memories",
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getMemoryDeclAccess().getCommaKeyword_2_1_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getMemoryDeclAccess().getMemoriesMemoryParserRuleCall_2_1_1_0()); 
	    }
		lv_memories_4_0=ruleMemory		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getMemoryDeclRule());
	        }
       		add(
...
(
		{ 
	        newCompositeNode(grammarAccess.getMemoryAccess().getTypeTypeParserRuleCall_0_0()); 
	    }
...
(
		{ 
	        newCompositeNode(grammarAccess.getTypeAccess().getTypeRefJvmTypeReferenceParserRuleCall_0()); 
	    }
		lv_typeRef_0_0=ruleJvmTypeReference		{
	        if ($current==null) {
...
((
    ...
    {
        $current = forceCreateModelElement(
            grammarAccess.getStateDeclAccess().getStateDeclAction_0(),
            $current);
    }
)	otherlv_1='states' 
    {
    	newLeafNode(otherlv_1, grammarAccess.getStateDeclAccess().getStatesKeyword_1());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getStateDeclAccess().getStatesStateParserRuleCall_2_0()); 
	    }
    ...
    {
    	newLeafNode(otherlv_3, grammarAccess.getStateDeclAccess().getCommaKeyword_3_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getStateDeclAccess().getStatesStateParserRuleCall_3_1_0()); 
	    }
...
entryRuleSTATEPATTERNDECL returns [String current=null] 
	:
	{ newCompositeNode(grammarAccess.getSTATEPATTERNDECLRule()); } 
	 iv_ruleSTATEPATTERNDECL=ruleSTATEPATTERNDECL 
	 { $current=$iv_ruleSTATEPATTERNDECL.current.getText(); }  
	 EOF 
;

// Rule STATEPATTERNDECL
ruleSTATEPATTERNDECL returns [AntlrDatatypeRuleToken current=new AntlrDatatypeRuleToken()] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(((
    ...
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getSTATEPATTERNDECLAccess().getAsteriskKeyword_0_0()); 
    }
)?    this_ID_1=RULE_ID    {
    ...
    { 
    newLeafNode(this_ID_1, grammarAccess.getSTATEPATTERNDECLAccess().getIDTerminalRuleCall_0_1()); 
    }
(
	kw='*' 
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getSTATEPATTERNDECLAccess().getAsteriskKeyword_0_2()); 
    }
)?)
    |
	kw='*' 
    {
        $current.merge(kw);
        newLeafNode(kw, grammarAccess.getSTATEPATTERNDECLAccess().getAsteriskKeyword_1()); 
    }
)
    ;
...
entryRuleVariableListDecl returns [EObject current=null] 
	:
	{ newCompositeNode(grammarAccess.getVariableListDeclRule()); }
	 iv_ruleVariableListDecl=ruleVariableListDecl 
	 { $current=$iv_ruleVariableListDecl.current; } 
	 EOF 
;

// Rule VariableListDecl
ruleVariableListDecl returns [EObject current=null] 
    @init { enterRule(); 
    }
    @after { leaveRule(); }:
(	otherlv_0='(' 
    {
    	newLeafNode(otherlv_0, grammarAccess.getVariableListDeclAccess().getLeftParenthesisKeyword_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getVariableListDeclAccess().getVariablesDeclVariableDeclParserRuleCall_1_0()); 
	    }
		lv_variablesDecl_1_0=ruleVariableDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getVariableListDeclRule());
	        }
       		add(
       			$current, 
       			"variablesDecl",
        		lv_variablesDecl_1_0, 
        		"VariableDecl");
	        afterParserOrEnumRuleCall();
	    }
    ...
    {
    	newLeafNode(otherlv_2, grammarAccess.getVariableListDeclAccess().getCommaKeyword_2_0());
    }
(
(
		{ 
	        newCompositeNode(grammarAccess.getVariableListDeclAccess().getVariablesDeclVariableDeclParserRuleCall_2_1_0()); 
	    }
		lv_variablesDecl_3_0=ruleVariableDecl		{
	        if ($current==null) {
	            $current = createModelElementForParent(grammarAccess.getVariableListDeclRule());
	        }
       		add(
    ...
    {
    	newLeafNode(otherlv_4, grammarAccess.getVariableListDeclAccess().getRightParenthesisKeyword_3());
    }
)
;
...
(
		{ 
	        newCompositeNode(grammarAccess.getVariableDeclAccess().getTypeTypeParserRuleCall_0_0()); 
	    }
		lv_type_0_0=ruleType		{
	        if ($current==null) {
